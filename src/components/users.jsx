...
const WorkersList = ({ onClose }) => {
  ...
  async function getWorkersList() {
    try {
      const response = await axios.post(
        "http://localhost/brikolZone/getWorkersList.php",
        {
          searchTerm,
          filter,
        },
  ...
  function handelDeleteBtn(workerID) {
    ...
    if (response) {
      axios
        .get(
          `http://localhost/brikolZone/deletWorker.php?workerID=${workerID}`,
          { withCredentials: true }
        )
        .then((response) => {
...
function ClientsList({onClose}) {
 ...
 { 
  ...
  async function getClientsList() {
    try {
      const response = await axios.post(
        "http://localhost/brikolZone/getClientsList.php",
        {
          searchTerm,
          filter,
        },
...
function Users() {
  ...
  useEffect(() => {
      axios
        .get("http://localhost/brikolZone/getWorkerAndClientsNumber.php", {
          withCredentials: true,
        })
        .then((response) => {
          if (response.data.status === "unauthenticated") {
        ...
        <div className="grid sm:grid-cols-12 gap-4 w-full bg-n max-w-2xl">
          <div className="sm:col-span-6  bg-[#28a745] shadow-lg rounded-2xl p-6   text-center">
            ...
            <div className="flex items-center justify-center space-x-2">
              ...
              <div>
                <h2 className="text-white text-xl font-bold">Workers {usersNumber.Workers}</h2>
                <a
          ...
          <div className="sm:col-span-6  bg-[#0d6efd] shadow-lg rounded-2xl p-6   text-center">
            ...
            <div className="flex items-center justify-center space-x-2">
              ...
              <div>
                <h2 className="text-white text-xl font-bold">Clients { usersNumber.Clients}</h2>
                <a
